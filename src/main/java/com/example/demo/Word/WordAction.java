...
public class WordAction {
    ...
    public String createWord(Map<String,Object> dataMap) {
        ...
        //文件唯一名称
        fileOnlyName = "downLoadWord" + sb + ".doc";

        //文件名称
        fileName = "downLoadWord.doc";

        /** 生成word */
        String filePathName = WordUtil.createWord(dataMap, "policyDocumentManagement.ftl", filePath, fileOnlyName);
        return filePathName;
    }
